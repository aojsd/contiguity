...
void count_pow2(u64 start, u64 end, u64 v_start, int pow_largest, u64* region_count) {
    ...
    // Lower sub-region
    count_pow2(start, start_aligned << pow_largest, v_start, pow_largest - 1, region_count);

    // Upper sub-region
    v_start += (end_aligned << pow_largest) - start;
    count_pow2(end_aligned << pow_largest, end, v_start, pow_largest - 1, region_count);
}