...
def main(args):
    ...
    parser.add_argument("--CPU", type=float, help="CPU usage limit", default=0)
    parser.add_argument("--TIME_DILATION", type=int, help="Time dilation factor", default=0)
    ...
    print(f"TIME_DILATION={args.TIME_DILATION}")
